local Language = {
    en = {
        ...
        AdvancedTools = "Advanced tools", ScanGame = "Scan experience", ScanningGame = "Scanning experience…",
    ...
    ar = {
        ...
        AdvancedTools = "الأدوات المتقدمة", ScanGame = "فحص التجربة", ScanningGame = "جارٍ فحص التجربة…",
